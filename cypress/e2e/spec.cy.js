describe('empty spec', () => {
  ...
  it('Should be able to use the form', () => {
    ...
    cy.get('.url').last().contains('h3', 'AAA')
    cy.get('.url').last().contains('a', 'http://localhost:3001/useshorturl/2')
    cy.get('.url').last().contains('p', 'https://images.unsplash.com/photo-1531898418865-480b7090470f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=934&q=80')
  })
